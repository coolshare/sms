...
class _DashboardContainer extends React.Component{
	constructor() {
		...
		this.gadgetMap = {"ResouceUsageGadget":ResouceUsageGadget, "ENGListGadget":ENGListGadget, "ENGAlertsGadget":ENGAlertsGadget}
	}
	adjustPosition = ()=> {
    ...
    */
	render(){
		...
		let aa = this.gadgetMap["ResouceUsageGadget"]
