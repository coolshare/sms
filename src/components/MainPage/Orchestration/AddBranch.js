		    	...
		    	<div>
		    		<div style={{"height":"50px", "fontSize":"200%"}}>Add Branch</div>
		      		<form onSubmit={ (e) => this.handleOK(e) } ref="AddBranchForm">
			      		<label className="field"  style={{'margin':'20px','width':'450px', 'paddingTop':'40px'}}>Branch Name:
							<input name="BranchName" ref={(input)=>{this.fields["BranchName"] = input}}  type="text" tabIndex="1" placeholder="Branch Name" style={{"width":"200px"}} />
			            </label>
