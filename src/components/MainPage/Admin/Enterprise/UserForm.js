				...
				<div className="infoDiv">
					...
					<form name = "info" action = "" method = "post">
							...
							<label className="properties">Username:
								<input name="Username" ref={(input)=>{this.fields["Username"] = input}}  type="text" tabIndex="1" placeholder="gagw" style={{"width":"200px"}} />
				            </label>
							
			
							{/* Pass */}
							<label className="properties">Password:
								<input name="Password" ref={(input)=>{this.fields["Password"] = input}}  type="text" tabIndex="1" placeholder="*******" style={{"width":"200px"}} />
				            </label>
							
							{/* Group (figure out dropdown later) */}
							<label className="properties">Group:
								<input name="Group" ref={(input)=>{this.fields["Group"] = input}}  type="text" tabIndex="1" placeholder="SuperUser" style={{"width":"200px"}} />
				            </label>
							
							
							{/* Name */}
							<label className="properties">Name:
								<input name="Name" ref={(input)=>{this.fields["Name"] = input}}  type="text" tabIndex="1" placeholder="Jack Paul" style={{"width":"200px"}} />
				            </label>
							
							{/* Number */}
							<label className="properties">Number:
								<input name="Number" ref={(input)=>{this.fields["Number"] = input}}  type="text" tabIndex="1" placeholder="3016772828" style={{"width":"200px"}} />
				            </label>
